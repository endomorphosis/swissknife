  ...
  execute: async (args: string[], options: Record<string, any>) => {
    ...
    switch (subcommand) {
      ...
      case 'deontic': {
        ...
        const { DeonticTextAnalyzer } = await import('../services/logic/deontic/deontic-text-analyzer.js');
        ...
        if (sub === 'fol') {
          ...
          const { FolTextConverter } = await import('../services/logic/fol/fol-text-converter.js');
