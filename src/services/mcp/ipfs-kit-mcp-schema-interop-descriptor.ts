 ...
 * interaction envelope schemas can carry `external/ipfs_kit`
 * bucket-VFS surface events end to end.
 *
...
export const SWISSKNIFE_IPFS_KIT_INTEROP_INTERFACE: MCPPPInterfaceDescriptor = {
  ...
  methods: [
    ...
    },
    {
      ...
      input_schema_cid: 'bafy_validatedep_in',
      output_schema_cid: 'bafy_validatedep_out',
    ...
    },
    {
      ...
      error_schema_cids: ['bafy_err_encoding'],
    },
    {
