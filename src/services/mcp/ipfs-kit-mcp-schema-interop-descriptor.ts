/**
 * SwissKnife <-> external/ipfs_kit MCP schema/bucket-VFS interoperability descriptor.
 *
 ...
 *
 * `external/ipfs_kit` ships bucket-VFS MCP tools, a dag-pb protobuf schema, a
 * deprecations report schema, and several `fix_mcp_schema.py` repair scripts.
 * This module describes that surface as a canonical MCP-IDL Profile A
...
export const IPFS_KIT_REQUIRED_DEPRECATIONS_REPORT_KEYS = [
  'report_version',
  'generated_at',
  'deprecated',
  'summary',
...
export const IPFS_KIT_INTEROP_OPERATIONS = [
  ...
  methods: [
    {
      ...
      error_schema_cids: ['bafy_ipfs_kit_err_schema_invalid'],
    },
    {
      name: 'ipfs_kit.mcp_schema.validate_deprecations_report',
      input_schema_cid: 'bafy_ipfs_kit_validate_deprecations_report_in',
      output_schema_cid: 'bafy_ipfs_kit_validate_deprecations_report_out',
      error_schema_cids: ['bafy_ipfs_kit_err_report_invalid'],
    },
    {
    ...
    },
    {
      ...
      input_schema_cid: 'bafy_ipfs_kit_dag_pb_encode_node_in',
      output_schema_cid: 'bafy_ipfs_kit_dag_pb_encode_node_out',
      error_schema_cids: ['bafy_ipfs_kit_err_dag_pb_invalid'],
    },
    {
      name: 'ipfs_kit.dag_pb.decode_node',
      input_schema_cid: 'bafy_ipfs_kit_dag_pb_decode_node_in',
      output_schema_cid: 'bafy_ipfs_kit_dag_pb_decode_node_out',
      error_schema_cids: ['bafy_ipfs_kit_err_dag_pb_invalid'],
    },
  ],
  errors: [
...
export const SWISSKNIFE_IPFS_KIT_INTEROP_DESCRIPTOR = {
  ...
  runtime_handoff: {
    ...
    deprecations_report_required_keys: IPFS_KIT_REQUIRED_DEPRECATIONS_REPORT_KEYS,
    required_swissknife_operations: IPFS_KIT_INTEROP_OPERATIONS,
