/**
 * SwissKnife <-> external/ipfs_kit MCP schema/DAG-PB interoperability descriptor.
 *
 ...
 *
 * `external/ipfs_kit` ships three ``fix_mcp_schema.py`` normalizers
 ...
 * (`data/deprecations_report.schema.json`), the bucket-VFS interface docs
 * (`docs/implementation/BUCKET_VFS_INTERFACES_COMPLETE.md`), and a DAG-PB
 * protobuf definition (`docs/py-ipld-dag-pb/ipld_dag_pb/dag-pb.proto`) that
 * SwissKnife's IPFS data surfaces can consume. This module describes that
 ...
 * control-surface and interaction-envelope payloads for validation.
 *
...
export const IPFS_KIT_MCP_SCHEMA_PATHS = {
  ...
  methods: [
    {
      ...
      input_schema_cid: 'bafy_kit_fix_servers_schema_in',
      output_schema_cid: 'bafy_kit_fix_servers_schema_out',
      error_schema_cids: ['bafy_kit_err_schema_invalid'],
    },
    {
      name: 'ipfs_kit.mcp_schema.validate_deprecations_report',
      input_schema_cid: 'bafy_kit_validate_deprecations_report_in',
      output_schema_cid: 'bafy_kit_validate_deprecations_report_out',
      error_schema_cids: ['bafy_kit_err_report_invalid'],
    },
    {
      name: 'ipfs_kit.bucket_vfs.export_car',
      input_schema_cid: 'bafy_kit_export_car_in',
      output_schema_cid: 'bafy_kit_export_car_out',
      error_schema_cids: ['bafy_kit_err_bucket_not_found'],
    },
    {
      name: 'ipfs_kit.bucket_vfs.cross_query',
      input_schema_cid: 'bafy_kit_cross_query_in',
      output_schema_cid: 'bafy_kit_cross_query_out',
      error_schema_cids: [],
