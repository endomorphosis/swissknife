 ...
 * registration/permission lifecycle docs, and a DisplayAccess Swift sample app.
 * This module describes that surface as a canonical MCP-IDL Profile A
 * descriptor that SwissKnife can register on the same MCP++ runtime registry as
 * the pre-built IPFS descriptors, and it provides representative
 * policy-mediated control-surface, interaction-envelope, and compatibility
 * receipt payloads for validation.
 *
 ...
 * the meta_glasses_display_widgets lane repair. HAO-736 remains the prior
 * hallucinate_multimodal_control lane proof for the same interface.
 */
