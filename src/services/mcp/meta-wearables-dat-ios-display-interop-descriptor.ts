 ...
 *
 * HAO-736 and VAI-667 objective validation repair: interface contract
 * swissknife external/meta-wearables-dat-ios,
 * goal_packet/interoperability/swissknife/06921590135c,
 * tests/integration/test_swissknife_external_meta_wearables_dat_ios_interop.py.
 *
 * `external/meta-wearables-dat-ios` ships DAT iOS Display capability docs and
 * the DisplayAccess Swift sample. This module exposes that surface as a
 * canonical MCP-IDL Profile A descriptor that SwissKnife can register on the
 * MCP++ runtime registry, and it provides representative policy-mediated
