 ...
 *
 * This module describes the Meta Wearables DAT iOS Display session,
 * registration, URL callback, and permission surfaces as a canonical MCP-IDL
 * interface that can be registered on SwissKnife's MCP++ runtime. The static
 * source descriptors live under `external/meta-wearables-dat-ios/.cursor/rules`
 * and the `samples/DisplayAccess` Swift sample.
 */
...
export const SWISSKNIFE_META_WEARABLES_DAT_IOS_INTEROP_INTERFACE: MCPPPInterfaceDescriptor = {
  ...
  methods: [
    ...
    },
    {
      ...
      error_schema_cids: ['bafy_err_callback_invalid'],
    },
    {
