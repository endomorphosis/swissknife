 ...
 * external/meta-wearables-dat-ios, goal_packet/interoperability/swissknife/06921590135c,
 ...
 * and the DisplayAccess sample app (Info.plist, DisplayViewModel.swift,
 * CarMaintenanceDisplay.swift). This module describes that surface as a
...
export const SWISSKNIFE_META_WEARABLES_DAT_IOS_INTEROP_INTERFACE: MCPPPInterfaceDescriptor = {
  ...
  version: '0.1.0',
  interface_cid: 'bafyswissknifemetawearablesdatios00001',
  methods: [
    {
    ...
    },
    {
      ...
      error_schema_cids: ['bafy_mwdat_ios_err_url_invalid'],
    },
    {
