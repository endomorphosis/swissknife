 ...
 * integration tests: interface contract swissknife external/meta-wearables-dat-ios,
 * goal_packet/interoperability/swissknife/06921590135c,
 * tests/integration/test_swissknife_external_meta_wearables_dat_ios_interop.py.
 *
 * `external/meta-wearables-dat-ios` ships Display/session docs and a real
 * DisplayAccess sample app. This module describes that surface as a canonical
 * MCP-IDL Profile A descriptor that SwissKnife can register on the same MCP++
 * runtime registry as the pre-built IPFS descriptors, and it provides
...
export const SWISSKNIFE_META_WEARABLES_DAT_IOS_INTEROP_INTERFACE: MCPPPInterfaceDescriptor =
  {
    ...
    version: '0.1.0',
    interface_cid: 'bafyswissknifemetawearablesdatiosdisplay000001',
    methods: [
      {
        ...
        error_schema_cids: ['bafy_mwdat_ios_err_registration'],
      },
      {
    ...
    errors: [
      { name: 'RegistrationError', code: 400 },
