 ...
 *
 * `external/meta-wearables-dat-ios` ships the DAT iOS Display capability docs
 * and the DisplayAccess Swift sample app. This module describes that surface as
 ...
 * representative policy-mediated control-surface, interaction-envelope,
 * compatibility-receipt, and mediation-receipt payloads for validation.
 *
...
export const SWISSKNIFE_META_WEARABLES_DAT_IOS_INTEROP_INTERFACE: MCPPPInterfaceDescriptor = {
  ...
  methods: [
    {
      ...
      error_schema_cids: ['bafy_mwdat_ios_err_registration_denied'],
    },
    {
      name: 'meta_wearables_dat_ios.registration.handle_url',
      input_schema_cid: 'bafy_mwdat_ios_registration_handle_url_in',
      output_schema_cid: 'bafy_mwdat_ios_registration_handle_url_out',
      error_schema_cids: ['bafy_mwdat_ios_err_registration_callback'],
    },
    {
  ...
  errors: [
    { name: 'RegistrationDenied', code: 403 },
    { name: 'RegistrationCallbackError', code: 400 },
...
export function buildSwissKnifeMetaWearablesDATIOSMediationReceipt() {
  return {
    receipt_id: 'receipt:swissknife-meta-wearables-dat-ios:allow:1',
    receipt_schema: 'mediation_receipt_v1',
    decision_id: 'decision:swissknife-meta-wearables-dat-ios:allow:1',
    interaction_id: 'interaction:swissknife-meta-wearables-dat-ios:send-display-view:1',
    ...
    policy_bundle_ref: META_WEARABLES_DAT_IOS_POLICY_BUNDLE_REF,
    control_surface_contract_ref: 'swissknife/contracts/control_surface_contract.schema.json',
    interaction_envelope_ref: 'swissknife/contracts/interaction_envelope.schema.json',
    reason: 'agent_identity, allowed_surfaces, and arguments_hash satisfied',
    obligations: [],
    created_at: '2026-07-08T00:00:05Z',
  };
}
