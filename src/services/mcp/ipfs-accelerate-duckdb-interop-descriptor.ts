...
export const IPFS_ACCELERATE_DUCKDB_SCHEMA_PATHS = {
  ...
  methods: [
    {
      ...
      input_schema_cid: 'bafy_accel_check_schema_in',
      output_schema_cid: 'bafy_accel_check_schema_out',
      error_schema_cids: [],
    },
    {
      name: 'accelerate.duckdb.get_all_tables',
      input_schema_cid: 'bafy_accel_get_all_tables_in',
      output_schema_cid: 'bafy_accel_get_all_tables_out',
      error_schema_cids: [],
    },
    {
      name: 'accelerate.duckdb.get_performance_results',
      input_schema_cid: 'bafy_accel_get_perf_results_in',
      output_schema_cid: 'bafy_accel_get_perf_results_out',
      error_schema_cids: ['bafy_accel_err_table_not_found'],
      interaction_pattern: 'request-response',
    },
    {
      name: 'accelerate.duckdb.create_performance_tables',
      input_schema_cid: 'bafy_accel_create_perf_tables_in',
      output_schema_cid: 'bafy_accel_create_perf_tables_out',
      error_schema_cids: ['bafy_accel_err_schema_conflict'],
    },
    {
      name: 'accelerate.duckdb.create_common_tables',
      input_schema_cid: 'bafy_accel_create_common_tables_in',
      output_schema_cid: 'bafy_accel_create_common_tables_out',
      error_schema_cids: ['bafy_accel_err_schema_conflict'],
    },
    {
      name: 'accelerate.duckdb.create_views',
      input_schema_cid: 'bafy_accel_create_views_in',
      output_schema_cid: 'bafy_accel_create_views_out',
      error_schema_cids: [],
    },
  ],
  errors: [
    { name: 'TableNotFound', code: 404 },
    { name: 'SchemaConflict', code: 409 },
  ],
...
export const SWISSKNIFE_IPFS_ACCELERATE_INTEROP_DESCRIPTOR = {
  ...
  schema_refs: {
    ...
    ...IPFS_ACCELERATE_DUCKDB_SCHEMA_PATHS,
  },
  runtime_handoff: {
    source_surface: 'swissknife',
    target_surface: 'external/ipfs_accelerate',
