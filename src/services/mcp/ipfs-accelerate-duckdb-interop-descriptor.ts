 ...
 * integration tests: interface contract swissknife external/ipfs_accelerate,
 * goal_packet/interoperability/swissknife/06921590135c,
 * tests/integration/test_swissknife_external_ipfs_accelerate_interop.py.
 *
 * `external/ipfs_accelerate` ships a DuckDB benchmark/time-series schema via
 * `external/ipfs_accelerate/data/duckdb/db_schema/time_series_schema.sql`,
 * `external/ipfs_accelerate/data/duckdb/scripts/create_benchmark_schema.py`,
 * `external/ipfs_accelerate/data/duckdb/utils/check_database_schema.py`, and
 * `external/ipfs_accelerate/data/duckdb/utils/check_db_schema.py`. This module
 * mirrors `src/handsfree/swissknife_ipfs_accelerate_interop.py` on the Python
 * side and keeps the shared `agent_identity`, `allowed_surfaces`, and
 * `arguments_hash` norm refs scanner-visible.
 *
...
export const IPFS_ACCELERATE_DUCKDB_TIME_SERIES_TABLES = [
...
export const IPFS_ACCELERATE_DUCKDB_BENCHMARK_SCHEMA_FUNCTIONS = [
  'create_performance_tables',
  'create_common_tables',
  'create_views',
] as const;

export const IPFS_ACCELERATE_DUCKDB_CHECK_SCHEMA_FUNCTIONS = [
  'check_schema',
  'get_all_tables',
...
export const SWISSKNIFE_IPFS_ACCELERATE_INTEROP_INTERFACE: MCPPPInterfaceDescriptor = {
  ...
  version: '0.1.0',
  interface_cid: 'bafyswissknifeipfsaccelerateduckdbinterop000000001',
  methods: [
    {
      name: 'accelerate.duckdb.check_schema',
      input_schema_cid: 'bafy_ipfs_accelerate_duckdb_check_schema_in',
      output_schema_cid: 'bafy_ipfs_accelerate_duckdb_check_schema_out',
      error_schema_cids: ['bafy_ipfs_accelerate_duckdb_err_invalid_schema'],
    },
    {
      name: 'accelerate.duckdb.get_all_tables',
      input_schema_cid: 'bafy_ipfs_accelerate_duckdb_get_all_tables_in',
      output_schema_cid: 'bafy_ipfs_accelerate_duckdb_get_all_tables_out',
      error_schema_cids: ['bafy_ipfs_accelerate_duckdb_err_invalid_schema'],
    },
    {
      name: 'accelerate.duckdb.get_performance_results',
      input_schema_cid: 'bafy_ipfs_accelerate_duckdb_get_performance_results_in',
      output_schema_cid: 'bafy_ipfs_accelerate_duckdb_get_performance_results_out',
      error_schema_cids: ['bafy_ipfs_accelerate_duckdb_err_missing_table'],
      interaction_pattern: 'request-response',
    },
    {
      name: 'accelerate.duckdb.create_performance_tables',
      input_schema_cid: 'bafy_ipfs_accelerate_duckdb_create_performance_tables_in',
      output_schema_cid: 'bafy_ipfs_accelerate_duckdb_create_performance_tables_out',
      error_schema_cids: ['bafy_ipfs_accelerate_duckdb_err_benchmark_schema'],
    },
    {
      name: 'accelerate.duckdb.create_common_tables',
      input_schema_cid: 'bafy_ipfs_accelerate_duckdb_create_common_tables_in',
      output_schema_cid: 'bafy_ipfs_accelerate_duckdb_create_common_tables_out',
      error_schema_cids: ['bafy_ipfs_accelerate_duckdb_err_benchmark_schema'],
    },
    {
      name: 'accelerate.duckdb.create_views',
      input_schema_cid: 'bafy_ipfs_accelerate_duckdb_create_views_in',
      output_schema_cid: 'bafy_ipfs_accelerate_duckdb_create_views_out',
      error_schema_cids: ['bafy_ipfs_accelerate_duckdb_err_benchmark_schema'],
    },
  ],
  errors: [
    { name: 'InvalidSchema', code: 422 },
    { name: 'MissingTable', code: 404 },
    { name: 'BenchmarkSchemaError', code: 500 },
  ],
...
export const SWISSKNIFE_IPFS_ACCELERATE_INTEROP_DESCRIPTOR = {
  ...
  runtime_handoff: {
    ...
    capability: 'accelerate.duckdb.benchmark_schema',
    allowed_surfaces: ['agent', 'mcp_server', 'remote_client'],
    time_series_tables: IPFS_ACCELERATE_DUCKDB_TIME_SERIES_TABLES,
    benchmark_schema_functions: IPFS_ACCELERATE_DUCKDB_BENCHMARK_SCHEMA_FUNCTIONS,
    check_schema_functions: IPFS_ACCELERATE_DUCKDB_CHECK_SCHEMA_FUNCTIONS,
  ...
  validation: {
    ...
    docs_ref: 'docs/integration/swissknife-external_ipfs_accelerate.md',
    test_ref: 'tests/integration/test_swissknife_external_ipfs_accelerate_interop.py',
    python_mirror_ref: 'src/handsfree/swissknife_ipfs_accelerate_interop.py',
...
export function buildSwissKnifeIPFSAccelerateMCPPlusPlusCompatibilityReceipt() {
  return {
    ...
    transport: {
      ...
      auth_present: true,
      redaction_profile: 'duckdb-benchmark-minimal',
    },
    tool_call: {
      tool_name: 'accelerate.duckdb.get_performance_results',
      tool_category: 'data',
      upstream_function: 'get_performance_results',
