 ...
 *
 * `external/ipfs_accelerate` ships a DuckDB-backed performance benchmark schema
 * (time-series tables, benchmark schema creation scripts, and schema-checking
 * utilities). This module describes that surface as a canonical MCP-IDL
 * Profile A descriptor that SwissKnife can register on the same MCP++ runtime
 * registry as the pre-built IPFS descriptors, and it provides representative
...
export const SWISSKNIFE_IPFS_ACCELERATE_INTEROP_INTERFACE: MCPPPInterfaceDescriptor = {
  ...
  version: '0.1.0',
  interface_cid: 'bafyswissknifeipfsaccelerateduckdb00001',
  methods: [
    {
      name: 'accelerate.duckdb.check_schema',
      input_schema_cid: 'bafy_ipfs_accelerate_check_schema_in',
      output_schema_cid: 'bafy_ipfs_accelerate_check_schema_out',
      error_schema_cids: ['bafy_ipfs_accelerate_err_schema_missing'],
    },
    {
      name: 'accelerate.duckdb.get_all_tables',
      input_schema_cid: 'bafy_ipfs_accelerate_get_all_tables_in',
      output_schema_cid: 'bafy_ipfs_accelerate_get_all_tables_out',
      error_schema_cids: [],
    },
    {
      name: 'accelerate.duckdb.get_performance_results',
      input_schema_cid: 'bafy_ipfs_accelerate_get_performance_results_in',
      output_schema_cid: 'bafy_ipfs_accelerate_get_performance_results_out',
      error_schema_cids: ['bafy_ipfs_accelerate_err_table_not_found'],
      interaction_pattern: 'request-response',
    },
    {
      name: 'accelerate.duckdb.create_performance_tables',
      input_schema_cid: 'bafy_ipfs_accelerate_create_performance_tables_in',
      output_schema_cid: 'bafy_ipfs_accelerate_create_performance_tables_out',
      error_schema_cids: ['bafy_ipfs_accelerate_err_ddl_failed'],
    },
    {
      name: 'accelerate.duckdb.create_common_tables',
      input_schema_cid: 'bafy_ipfs_accelerate_create_common_tables_in',
      output_schema_cid: 'bafy_ipfs_accelerate_create_common_tables_out',
      error_schema_cids: ['bafy_ipfs_accelerate_err_ddl_failed'],
    },
    {
      name: 'accelerate.duckdb.create_views',
      input_schema_cid: 'bafy_ipfs_accelerate_create_views_in',
      output_schema_cid: 'bafy_ipfs_accelerate_create_views_out',
      error_schema_cids: ['bafy_ipfs_accelerate_err_ddl_failed'],
    },
  ],
  errors: [
    { name: 'SchemaMissing', code: 404 },
    { name: 'TableNotFound', code: 404 },
    { name: 'DDLFailed', code: 500 },
  ],
...
export const SWISSKNIFE_IPFS_ACCELERATE_INTEROP_DESCRIPTOR = {
  ...
  runtime_handoff: {
    ...
    required_swissknife_operations: IPFS_ACCELERATE_DUCKDB_INTEROP_OPERATIONS,
