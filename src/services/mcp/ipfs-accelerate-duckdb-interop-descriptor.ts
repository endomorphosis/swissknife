/**
 * SwissKnife <-> external/ipfs_accelerate DuckDB interoperability descriptor.
 *
 ...
 *
 * `external/ipfs_accelerate` ships DuckDB benchmark schema descriptors that
 * SwissKnife can consume as a policy-mediated MCP++ data-service surface. This
 * module describes that surface as a canonical MCP-IDL Profile A descriptor and
 * provides representative control-surface and interaction-envelope payloads
 * for validation.
 */
...
export const IPFS_ACCELERATE_DUCKDB_SCHEMA_DESCRIPTOR_PATHS = {
  time_series_schema:
  ...
  methods: [
    {
      ...
      error_schema_cids: ['bafy_accelerate_duckdb_err_schema_missing'],
    },
    {
    ...
    },
    {
      ...
      error_schema_cids: ['bafy_accelerate_duckdb_err_table_missing'],
      interaction_pattern: 'request-response',
      resource_cost_hints: { latency_ms: 250 },
    },
    {
      ...
      error_schema_cids: ['bafy_accelerate_duckdb_err_write_failed'],
    },
    {
...
export const SWISSKNIFE_IPFS_ACCELERATE_INTEROP_DESCRIPTOR = {
  ...
  schema_refs: {
    ...
    ...IPFS_ACCELERATE_DUCKDB_SCHEMA_DESCRIPTOR_PATHS,
  },
  runtime_handoff: {
    source_surface: 'swissknife',
    target_surface: 'external/ipfs_accelerate',
