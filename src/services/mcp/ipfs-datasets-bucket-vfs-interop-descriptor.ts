 ...
 *
 * `external/ipfs_datasets` vendors a bucket-VFS MCP tool surface (via its
 * bundled `.tools/ipfs_kit_py` checkout) with a unified multi-backend bucket
 * interface (Parquet, Arrow, S3, SSHFS, GDrive) and a deprecations report
 * schema. This module describes that surface as a canonical MCP-IDL Profile A
 * descriptor that SwissKnife can register on the same MCP++ runtime registry
 * as the pre-built IPFS descriptors, and it provides representative
 * policy-mediated control-surface and interaction-envelope payloads for
 * validation.
 *
...
export const IPFS_DATASETS_REQUIRED_BUCKET_VFS_CLI_COMMANDS = [
  'create',
  'list',
  'delete',
  'add-file',
...
export const IPFS_DATASETS_REQUIRED_DEPRECATIONS_REPORT_KEYS = [
  'report_version',
  'generated_at',
  'deprecated',
  'summary',
...
export const IPFS_DATASETS_REQUIRED_UNIFIED_BUCKET_CLASSES = [
...
export const IPFS_DATASETS_REQUIRED_UNIFIED_BUCKET_METHODS = [
  'initialize',
...
export const SWISSKNIFE_IPFS_DATASETS_INTEROP_INTERFACE: MCPPPInterfaceDescriptor = {
  ...
  version: '0.1.0',
  interface_cid: 'bafyswissknifeipfsdatasetsbucketvfs00001',
  methods: [
    {
      name: 'ipfs_datasets.bucket_vfs.create_bucket',
      input_schema_cid: 'bafy_ipfs_datasets_create_bucket_in',
      output_schema_cid: 'bafy_ipfs_datasets_create_bucket_out',
      error_schema_cids: ['bafy_ipfs_datasets_err_bucket_exists'],
    },
    {
      name: 'ipfs_datasets.bucket_vfs.add_file',
      input_schema_cid: 'bafy_ipfs_datasets_add_file_in',
      output_schema_cid: 'bafy_ipfs_datasets_add_file_out',
      error_schema_cids: ['bafy_ipfs_datasets_err_bucket_not_found'],
    },
    {
      name: 'ipfs_datasets.bucket_vfs.export_car',
      input_schema_cid: 'bafy_ipfs_datasets_export_car_in',
      output_schema_cid: 'bafy_ipfs_datasets_export_car_out',
      error_schema_cids: ['bafy_ipfs_datasets_err_bucket_not_found'],
    },
    {
      name: 'ipfs_datasets.bucket_vfs.cross_query',
      input_schema_cid: 'bafy_ipfs_datasets_cross_query_in',
      output_schema_cid: 'bafy_ipfs_datasets_cross_query_out',
      error_schema_cids: ['bafy_ipfs_datasets_err_bucket_not_found'],
      interaction_pattern: 'request-response',
    },
    {
      name: 'ipfs_datasets.unified_bucket.create_backend_bucket',
      input_schema_cid: 'bafy_ipfs_datasets_create_backend_bucket_in',
      output_schema_cid: 'bafy_ipfs_datasets_create_backend_bucket_out',
      error_schema_cids: ['bafy_ipfs_datasets_err_backend_unavailable'],
    },
    {
      name: 'ipfs_datasets.unified_bucket.sync_indices',
      input_schema_cid: 'bafy_ipfs_datasets_sync_indices_in',
      output_schema_cid: 'bafy_ipfs_datasets_sync_indices_out',
      error_schema_cids: ['bafy_ipfs_datasets_err_backend_unavailable'],
    },
    {
      name: 'ipfs_datasets.deprecations.validate_report',
      input_schema_cid: 'bafy_ipfs_datasets_validate_report_in',
      output_schema_cid: 'bafy_ipfs_datasets_validate_report_out',
      error_schema_cids: ['bafy_ipfs_datasets_err_report_invalid'],
    },
  ],
  errors: [
...
export const SWISSKNIFE_IPFS_DATASETS_INTEROP_DESCRIPTOR = {
  ...
  runtime_handoff: {
    ...
    bucket_vfs_cli_commands: IPFS_DATASETS_REQUIRED_BUCKET_VFS_CLI_COMMANDS,
    unified_bucket_backends: IPFS_DATASETS_REQUIRED_UNIFIED_BUCKET_BACKENDS,
    unified_bucket_classes: IPFS_DATASETS_REQUIRED_UNIFIED_BUCKET_CLASSES,
    unified_bucket_methods: IPFS_DATASETS_REQUIRED_UNIFIED_BUCKET_METHODS,
    required_swissknife_operations: IPFS_DATASETS_INTEROP_OPERATIONS,
