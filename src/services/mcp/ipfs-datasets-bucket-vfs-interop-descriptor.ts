 ...
 *
 * `external/ipfs_datasets` ships bucket-VFS and unified-bucket interfaces
 ...
 * SwissKnife's data surfaces can route through for S3-like bucket semantics
 * across multiple storage backends. This module describes that surface as
 * a canonical MCP-IDL Profile A descriptor that SwissKnife can register on
 * the same MCP++ runtime registry as the pre-built IPFS descriptors, and it
...
export const IPFS_DATASETS_BUCKET_VFS_PATHS = {
...
export const SWISSKNIFE_IPFS_DATASETS_INTEROP_INTERFACE: MCPPPInterfaceDescriptor = {
  ...
  version: '0.1.0',
  interface_cid: 'bafyswissknifeipfsdatasetsbucketvfs0000001',
  methods: [
    {
      name: 'ipfs_datasets.bucket_vfs.create_bucket',
      input_schema_cid: 'bafy_datasets_create_bucket_in',
      output_schema_cid: 'bafy_datasets_create_bucket_out',
      error_schema_cids: ['bafy_datasets_err_bucket_exists'],
    },
    {
      name: 'ipfs_datasets.bucket_vfs.add_file',
      input_schema_cid: 'bafy_datasets_add_file_in',
      output_schema_cid: 'bafy_datasets_add_file_out',
      error_schema_cids: ['bafy_datasets_err_bucket_not_found'],
    },
    {
      name: 'ipfs_datasets.bucket_vfs.export_car',
      input_schema_cid: 'bafy_datasets_export_car_in',
      output_schema_cid: 'bafy_datasets_export_car_out',
      error_schema_cids: ['bafy_datasets_err_bucket_not_found'],
    },
    {
      name: 'ipfs_datasets.bucket_vfs.cross_query',
      input_schema_cid: 'bafy_datasets_cross_query_in',
      output_schema_cid: 'bafy_datasets_cross_query_out',
      error_schema_cids: [],
      interaction_pattern: 'request-response',
    },
    {
      name: 'ipfs_datasets.unified_bucket.create_backend_bucket',
      input_schema_cid: 'bafy_datasets_create_backend_bucket_in',
      output_schema_cid: 'bafy_datasets_create_backend_bucket_out',
      error_schema_cids: ['bafy_datasets_err_backend_unavailable'],
    },
    {
      name: 'ipfs_datasets.unified_bucket.sync_indices',
      input_schema_cid: 'bafy_datasets_sync_indices_in',
      output_schema_cid: 'bafy_datasets_sync_indices_out',
      error_schema_cids: [],
    },
    {
      name: 'ipfs_datasets.deprecations.validate_report',
      input_schema_cid: 'bafy_datasets_validate_report_in',
      output_schema_cid: 'bafy_datasets_validate_report_out',
...
export const SWISSKNIFE_IPFS_DATASETS_INTEROP_DESCRIPTOR = {
  ...
  schema_refs: {
    ...
    ...IPFS_DATASETS_BUCKET_VFS_PATHS,
  },
  runtime_handoff: {
    source_surface: 'swissknife',
    target_surface: 'external/ipfs_datasets',
