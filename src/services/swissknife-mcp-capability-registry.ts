...
// Legacy HAO-674 evidence path retained for supervisor scans that still read
// swissknife/src/services/swissknife-mcp-capability-registry.ts directly.
...
// ipfs_datasets_py ipfs-datasets port: 3002
// ipfs_accelerate_py ipfs-accelerate port: 3003
