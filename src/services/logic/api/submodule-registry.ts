...
const _SPECS: LogicSubmoduleSpec[] = [
  ...
  { name: 'deontic-kb',    module: 'src/services/logic/deontic/deontic-knowledge-base', description: 'Temporal deontic KB with rule inference', roles: ['deontic', 'kb'], capabilities: ['rule_inference', 'compliance_check'], status: 'implemented', sprint: 12, source_file: 'deontic/deontic-knowledge-base.ts', public_symbols: ['DeonticKnowledgeBase'], notes: '' },
  { name: 'deontic-graph', module: 'src/services/logic/deontic/deontic-graph',        description: 'Typed O/P/F/R node+rule graph with conflict detection', roles: ['deontic', 'graph'], capabilities: ['detect_conflicts', 'assess_rules', 'source_gap'], status: 'implemented', sprint: 16, source_file: 'deontic/deontic-graph.ts', public_symbols: ['DeonticGraph', 'DeonticGraphBuilder'], notes: '' },
  ...
  // --- FOL / NL ---
  { name: 'fol-converter', module: 'src/services/logic/fol/fol-text-converter',       description: 'Regex NL→FOL converter (∀x/∃x, Prolog, TPTP)', roles: ['fol', 'nlp'], capabilities: ['extract_predicates', 'parse_quantifiers', 'build_formula'], status: 'implemented', sprint: 14, source_file: 'fol/fol-text-converter.ts', public_symbols: ['FolTextConverter'], notes: '' },
