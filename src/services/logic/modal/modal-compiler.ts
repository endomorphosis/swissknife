...
const COMPILER_REFINED_MARGIN_BY_PAIR: Record<string, number> = {
  ...
  'conditional_normative->conditional_normative': 0.02,
  'conditional_normative->deontic': 0.0015,
  'conditional_normative->temporal': 0.0015,
  'conditional_normative->epistemic': 0.0015,
  'conditional_normative->dynamic': 0.0015,
  'conditional_normative->frame': 0.0015,
  'deontic->alethic': 0.0015,
  'deontic->conditional_normative': 0.095,
  'deontic->deontic': 0.086,
  'deontic->temporal': 0.08,
  'deontic->epistemic': 0.0015,
  'deontic->dynamic': 0.325,
  'deontic->frame': 0.28,
  ...
  'epistemic->conditional_normative': 0.0015,
  'epistemic->deontic': 0.0015,
  'dynamic->dynamic': 0.02,
  'frame->alethic': 0.0015,
  'frame->conditional_normative': 0.36,
  'frame->deontic': 0.415,
  'frame->temporal': 0.13,
  'frame->epistemic': 0.38,
  'frame->dynamic': 0.0015,
  'frame->frame': 0.135,
  'frame->doxastic': 0.18,
  'doxastic->conditional_normative': 0.0015,
};
