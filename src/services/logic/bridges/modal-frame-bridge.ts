...
import { ProverRouterBridgeAdapter } from './prover-router-bridge.js';
import type { ProofGateResult } from './prover-router-bridge.js';
import {
  Atom, Obligation, Permission, Prohibition,
} from '../dcec/dcec-types.js';
import type { DCECFormula } from '../dcec/dcec-types.js';
import type { TdfolFormula } from '../tdfol/tdfol-types.js';
