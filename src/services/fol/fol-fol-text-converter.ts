...
export class FolTextConverter {
  ...
  private readonly _scorer: import('./fol-ml-confidence-scorer.js').MLConfidenceScorer | null = null;

  constructor() {
    // Lazy-load MLConfidenceScorer to avoid circular deps
    void import('./fol-ml-confidence-scorer.js').then(({ MLConfidenceScorer }) => {
