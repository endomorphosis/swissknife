...
import { base64Encode, bytesToHex, hexToBytes, sha256Hex, utf8Bytes } from '../shared/shared-browser-crypto.js';
...
export const BROWSER_SCHNORR_WASM_BASE64 = 'AGFzbQEAAAABCAFgA39/fwF/AwIBAAcLAQdhZGRfbW9kAAAKLQErAQJ/IAAgAnAhAyABIAJwIQQgAyACIARrTwR/IAMgAiAEa2sFIAMgBGoLCw==';
...
const BROWSER_SCHNORR_WASM_BYTES = new Uint8Array([
  ...
  // (a % modulus + b % modulus) % modulus without overflowing i32. The two
  // locals hold reduced operands; the conditional subtracts modulus before
  // an addition could wrap.
  0x2d, 0x01, 0x2b, 0x01, 0x02, 0x7f, 0x20, 0x00, 0x20, 0x02, 0x70, 0x21,
  0x03, 0x20, 0x01, 0x20, 0x02, 0x70, 0x21, 0x04, 0x20, 0x03, 0x20, 0x02,
  0x20, 0x04, 0x6b, 0x4f, 0x04, 0x7f, 0x20, 0x03, 0x20, 0x02, 0x20, 0x04,
  0x6b, 0x6b, 0x05, 0x20, 0x03, 0x20, 0x04, 0x6a, 0x0b, 0x0b,
]);
