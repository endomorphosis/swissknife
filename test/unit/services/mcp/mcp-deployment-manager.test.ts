...
// No change needed here as the previous replacement was correct
// No change needed here as the previous replacement was correct
// No change needed here as the previous replacement was correct
// No change needed here as the previous replacement was correct

// Mock the registry
jest.mock('../../../../src/services/mcp/mcp-registry.ctor', () => {
...
jest.mock('../../../../src/utils/config', () => ({
  getCurrentProjectConfig: jest.fn(() => configUtils.getCurrentProjectConfig),
  getGlobalConfig: jest.fn(() => configUtils.getGlobalConfig),
  getMcprcConfig: jest.fn(() => configUtils.getMcprcConfig),
}));
...
describe('DeploymentManager', () => {
  ...
  describe('getVersionHistory', () => {
    ...
    it('should return formatted version history', () => {
      ...
      expect(result.find((e: any) => e.type === 'status' && e.details.includes('blue'))).toBeDefined();
      expect(result.find((e: any) => e.type === 'traffic' && e.details.includes('100%'))).toBeDefined();
      expect(result.find((e: any) => e.type === 'rollback')).toBeDefined();
    });
