...
import { applyAlphaRule, applyBetaRule, isAlphaFormula, isBetaFormula, propositionalTableauxExpand, toProofStepWire } from '../../src/services/logic/cec/cec-modal-tableaux.js';
import { synthesisHintsFromAutoencoderIntrospection } from '../../src/services/logic/modal/modal-synthesis.js';
import { residualSignatureForHint } from '../../src/services/logic/modal/modal-synthesis.js';
import { augmentLegalIrProjectionTriples, LEGAL_CITATION_STRUCTURE, LEGAL_DOCUMENT_SCOPE } from '../../src/services/logic/modal/modal-kg-bridge.js';
import { withFLogicOptimizer } from '../../src/services/logic/modal/modal-logic-codec.js';
