...
<<<<<<< HEAD
  { modulePath: '../../src/services/proof-engine/base-prover-bridge', expectedExports: ['BaseProverBridge', 'BridgeCapability', 'BridgeRegistry', 'StubProverBridge'] },
  ...
  { modulePath: '../../src/services/zkp/zkp-to-ucan-bridge', expectedExports: ['ZKPToUCANBridge', 'getZkpUcanBridge'] },
  ...
  { modulePath: '../../src/services/proof-engine/proof-cache-base', expectedExports: ['CachedProof', 'ProofCache', 'BoundedCache'] },
