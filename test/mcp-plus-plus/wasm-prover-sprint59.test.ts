...
import { FLogicProofCache, getGlobalCachedWrapper } from '../../src/services/integrations/flogic-proof-cache.js';
import { NLUCANPolicyCompiler, compileNlToUcanPolicy } from '../../src/services/logic/nl/nl-ucan-policy-compiler.js';
import { LegalVocabulary, MedicalVocabulary, TechnicalVocabulary, DomainVocabularyManager } from '../../src/services/logic/shared/domain-vocabulary.js';
import { NaturalLanguageConverter, createEnhancedNlConverter } from '../../src/services/logic/cec/cec-nl-converter.js';
import { ShadowProverWrapper, ProverStatus } from '../../src/services/integrations/shadow-prover-wrapper.js';
