...
import { ProverRouterBridgeAdapter } from '../../src/services/bridge/bridge-prover-router-bridge.js';
import type { TdfolFormula } from '../../src/services/provers/provers-tdfol-types.js';
...
describe('T-76/T-77 ExtendedTdfolProverBridge — extended rules', () => {
  ...
  it('TemporalObligationPersistence: O(□φ) ⊢ □O(φ)', async () => {
    ...
    const kb: TdfolFormula[] = [Obligation(Always(phi) as unknown as import('../../src/services/provers/provers-dcec-types.js').DCECFormula)];
