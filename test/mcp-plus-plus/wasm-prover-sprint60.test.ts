...
import { GrammarEngine, CompositeGrammar, Category, makeBinaryRule, makeUnaryRule } from '../../src/services/logic/cec/cec-grammar-engine.js';
import { parseExpressionToToken, tokenToFormula, parseDcecString, validateFormula, DCECParsingError } from '../../src/services/logic/dcec/dcec-integration.js';
import { ContextManager, AnaphoraResolver, DiscourseAnalyzer, EntityType, makeEntity } from '../../src/services/logic/cec/cec-context-manager.js';
import { CachedTheoremProver, getGlobalCachedProver } from '../../src/services/logic/cec/cec-proof-cache.js';
import { DCECPrototypeNamespace, TDFOLPerformanceEngine } from '../../src/services/logic/dcec/dcec-prototypes.js';
import { makeSort, SORT_OBJECT } from '../../src/services/logic/dcec/dcec-core-types.js';
