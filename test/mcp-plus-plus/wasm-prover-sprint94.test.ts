...
import { Groth16Backend, Groth16BackendFallback, ProveKitFFI, ProveKitFFIError } from '../../src/services/zkp/zkp-backends.js';
...
import { deriveTdfolV1Trace, legalTheoremToCircuit } from '../../src/services/zkp/legal-theorem-semantics.js';
...
import { WitnessManager, computeWitness, validateWitness, derivePublicInputs } from '../../src/services/zkp/witness-manager.js';
...
import { ZKPVerifier, verifyProof, makeSimulatedVK } from '../../src/services/zkp/zkp-verifier.js';
...
import { SetupArtifactStore, runTrustedSetup, getOrCreateArtifact } from '../../src/services/zkp/setup-artifacts.js';
...
import { VKRegistry, registerVK, lookupVK, getVKRegistry } from '../../src/services/zkp/vk-registry.js';
