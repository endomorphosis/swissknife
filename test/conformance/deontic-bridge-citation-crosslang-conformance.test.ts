...
import { deonticCitationFromNorms } from '../../src/services/logic/bridges/deontic-norms-bridge.js';
...
function runPythonReference(corpusPath: string): PyResults {
  const tempDir = mkdtempSync(join(tmpdir(), 'deontic-bridge-citation-py-'));
