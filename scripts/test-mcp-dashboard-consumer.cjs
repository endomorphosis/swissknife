...
assert(vai649Gate?.attempt === 1, 'VAI-649 launch gate must preserve the attempt-1 validation receipt number');
assert(
  ...
  'VAI-649 launch gate must expose the attempt-1 launch Playwright validation receipt',
);
assert(
