...
assert(
  ...
  'HAO-727 launch gate must point at the Hallucinate fixture',
);
assert(
...
for (const term of [
  ...
  assert((hao727Gate?.required_evidence || []).includes(term), 'HAO-727 launch gate missing evidence term ' + term);
}
