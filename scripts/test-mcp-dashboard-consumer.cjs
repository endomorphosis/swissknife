...
assert(
  vai597Gate?.attempt === 1,
  'VAI-597 launch gate must expose the attempt-1 validation receipts for Swissknife consumers',
);
assert(
  ...
  'VAI-597 launch gate must point at the attempt-1 validation receipts',
);
