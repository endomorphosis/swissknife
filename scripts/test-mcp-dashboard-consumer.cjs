...
assert(
  vai566Gate?.attempt === 1,
  'VAI-566 launch gate must expose the attempt-1 validation receipts for Swissknife consumers',
);
assert(
  ...
  'VAI-566 launch gate must point at the attempt-1 validation receipts',
);
