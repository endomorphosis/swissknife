...
Generated: 2026-07-20T00:30:27.751Z
Matrix CID: `sha256:dfa7876a20164e10d541517d900125f23e756aa1d8edeca0134af5c28e743dd6`

## Summary

- Virtual desktop apps: 45
- Tool-backed apps with at least one binding row: 16
- Tool-backed apps with app-visible tools: 16
- Manifest-only apps: 11
- Not-applicable apps: 4
- App-visible capabilities: 199
- Desktop/mobile-only capabilities: 13
- Supervisor-only capabilities: 108
- Backend contract apps: 45
- Backend contract capabilities: 320
- Local-only apps with rationale: 29/29
- Contract CID: `sha256:a43531a89877ea33c161087e972245c81401df69f5027caf32931fa5e0835a0a`
...
| api-keys | tool_backed | Secret inventory and rotation map to ipfs_kit_py secret-management tools with confirmation/receipt policy. | 0 | 0 | 0 | ipfs_kit_py | 0 | 0 |
...
| cinema | tool_backed | Media import/export and content-addressed playback use IPFS file and block retrieval capabilities. | 0 | 0 | 0 | ipfs_kit_py | 0 | 0 |
...
| file-manager | tool_backed | File, bucket, MFS, VFS, and journal operations are app-owned IPFS storage capabilities. | 6 | 1 | 7 | ipfs_kit_py | 1 | 1 |
...
| github | tool_backed | GitHub repository, issue, PR, and review tools are concrete MCP capabilities surfaced with confirmation policy. | 15 | 2 | 16 | ipfs_accelerate_py, ipfs_datasets_py | 9 | 9 |
...
| ipfs-explorer | tool_backed | Primary browser for IPFS block, DAG, pin, name, and gateway capabilities. | 0 | 0 | 0 | ipfs_kit_py | 0 | 0 |
| mcp-control | tool_backed | Control-plane tools, policy/IDL inspection, and supervisor-owned tools remain visible here with explicit disposition. | 12 | 1 | 11 | ipfs_kit_py, ipfs_datasets_py, ipfs_accelerate_py | 8 | 8 |
| media-player | tool_backed | Content-addressed media playback uses IPFS cat/get/file-list capabilities. | 0 | 0 | 0 | ipfs_kit_py | 0 | 0 |
| model-browser | tool_backed | Model search, metadata, recommendation, and vector lookup tools are owned by this app. | 0 | 0 | 0 | ipfs_accelerate_py, ipfs_datasets_py | 0 | 0 |
...
| neural-network-designer | tool_backed | Graph, workflow, and model-design capabilities map to dataset graph tools and accelerate workflow tools. | 0 | 0 | 0 | ipfs_accelerate_py, ipfs_datasets_py | 0 | 0 |
| neural-photoshop | tool_backed | Image/media analysis, conversion, embedding, and inference workflows are MCP-backed. | 0 | 0 | 0 | ipfs_accelerate_py, ipfs_datasets_py | 0 | 0 |
| notes | tool_backed | Note search, summarization, provenance, and dataset save/load use ipfs_datasets_py tools. | 0 | 0 | 0 | ipfs_datasets_py | 0 | 0 |
...
| peertube | tool_backed | P2P video playback uses IPFS naming, pin, and content retrieval capabilities. | 0 | 0 | 0 | ipfs_kit_py | 0 | 0 |
...
| system-monitor | tool_backed | System, audit, performance, health, and telemetry capabilities are app-owned monitoring tools. | 14 | 1 | 8 | ipfs_kit_py, ipfs_accelerate_py | 8 | 8 |
...
| vibecode | tool_backed | Code search, documentation, linting, and review tools from ipfs_datasets_py are surfaced as app-owned developer capabilities. | 0 | 0 | 0 | ipfs_datasets_py | 0 | 0 |
| datasets-browser | tool_backed | Generated dataset descriptors expose ipfs_datasets_py discovery, index, vector, and provenance tools. | 13 | 0 | 0 | ipfs_datasets_py | 4 | 4 |
...
| mcp-plus-plus | tool_backed | MCP++ Explorer owns complete MCP/MCP++ catalog, gateway, receipt, and event-DAG inspection. | 47 | 3 | 0 | ipfs_kit_py, ipfs_datasets_py, ipfs_accelerate_py | 12 | 12 |
| agent-supervisor | tool_backed | Agent Supervisor exposes bounded goal, queue, taskboard, run-history, steering, and receipt workflows through typed MCP/MCP++ capabilities. | 16 | 0 | 14 | ipfs_accelerate_py, ipfs_datasets_py, ipfs_kit_py | 3 | 3 |
...
| file-manager | - | 14 | - | manual:1 | success/fallback/error |
| friends-list | - | 0 | yes | not-required:0 | success/fallback/error |
| github | - | 33 | - | manual:9 | success/fallback/error |
| huggingface | - | 14 | - | manual:6 | success/fallback/error |
| image-viewer | - | 0 | yes | not-required:0 | success/fallback/error |
| ipfs-explorer | - | 0 | yes | not-required:0 | success/fallback/error |
| mcp-control | - | 24 | - | manual:8 | success/fallback/error |
| media-player | - | 0 | yes | not-required:0 | success/fallback/error |
| model-browser | - | 0 | yes | not-required:0 | success/fallback/error |
...
| neural-network-designer | - | 0 | yes | not-required:0 | success/fallback/error |
| neural-photoshop | - | 0 | yes | not-required:0 | success/fallback/error |
| notes | - | 0 | yes | not-required:0 | success/fallback/error |
...
| peertube | - | 0 | yes | not-required:0 | success/fallback/error |
...
| system-monitor | - | 23 | - | manual:8 | success/fallback/error |
...
| vibecode | code-editor | 0 | yes | not-required:0 | success/fallback/error |
| datasets-browser | - | 13 | - | manual:4 | success/fallback/error |
...
| mcp-plus-plus | - | 50 | - | manual:12 | success/fallback/error |
| agent-supervisor | - | 30 | - | manual:3 | success/fallback/error |
