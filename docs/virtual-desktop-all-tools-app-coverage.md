...
Matrix CID: `sha256:ef99517585703a6039c0875133da28b333ae630be093e318afa017022f9d3acb`

## Summary

- Virtual desktop apps: 45
- Tool-backed apps with at least one binding row: 22
- Tool-backed apps with app-visible tools: 22
- Manifest-only apps: 11
- Not-applicable apps: 4
- App-visible capabilities: 447
- Desktop/mobile-only capabilities: 26
- Supervisor-only capabilities: 108
- Backend contract apps: 45
- Backend contract capabilities: 581
- Local-only apps with rationale: 23/23
- Contract CID: `sha256:30790cf62ce1bdcd71fb77940c4724fbe3bda9126113b71d24eb61fd39701ded`
...
| github | tool_backed | GitHub repository, issue, PR, and review tools are concrete MCP capabilities surfaced with confirmation policy. | 22 | 2 | 16 | ipfs_accelerate_py, ipfs_datasets_py | 14 | 14 |
...
| ipfs-explorer | tool_backed | Primary browser for IPFS block, DAG, pin, name, and gateway capabilities. | 5 | 0 | 0 | ipfs_kit_py | 4 | 4 |
| mcp-control | tool_backed | Control-plane tools, policy/IDL inspection, and supervisor-owned tools remain visible here with explicit disposition. | 20 | 3 | 11 | ipfs_kit_py, ipfs_datasets_py, ipfs_accelerate_py | 12 | 12 |
...
| neural-photoshop | tool_backed | Image/media analysis, conversion, embedding, and inference workflows are MCP-backed. | 18 | 8 | 0 | ipfs_accelerate_py, ipfs_datasets_py | 6 | 6 |
...
| system-monitor | tool_backed | System, audit, performance, health, and telemetry capabilities are app-owned monitoring tools. | 23 | 1 | 8 | ipfs_kit_py, ipfs_accelerate_py | 11 | 11 |
...
| mcp-plus-plus | tool_backed | MCP++ Explorer owns complete MCP/MCP++ catalog, gateway, receipt, and event-DAG inspection. | 66 | 5 | 0 | ipfs_kit_py, ipfs_datasets_py, ipfs_accelerate_py | 16 | 16 |
| agent-supervisor | tool_backed | Agent Supervisor exposes bounded goal, queue, taskboard, run-history, steering, and receipt workflows through typed MCP/MCP++ capabilities. | 17 | 0 | 14 | ipfs_accelerate_py, ipfs_datasets_py, ipfs_kit_py | 4 | 4 |
...
| github | - | 40 | - | manual:14 | success/fallback/error |
| huggingface | - | 14 | - | manual:6 | success/fallback/error |
| image-viewer | - | 0 | yes | not-required:0 | success/fallback/error |
| ipfs-explorer | - | 5 | - | manual:4 | success/fallback/error |
| mcp-control | - | 34 | - | manual:12 | success/fallback/error |
...
| neural-photoshop | - | 26 | - | manual:6 | success/fallback/error |
...
| system-monitor | - | 32 | - | manual:11 | success/fallback/error |
...
| mcp-plus-plus | - | 71 | - | manual:16 | success/fallback/error |
| agent-supervisor | - | 31 | - | manual:4 | success/fallback/error |
